				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" class="form-control" data-fv-digits="true" name="duration" id="duration"
						       placeholder="Formato: 1.50 = 1h30min">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<textarea class="form-control" name="notes" id="notes" rows="5"
						          placeholder="Dejanos aqui el enlace a la captura del tracker de IVAO para confirmar tu vuelo Enlace del tracker: https://tracker.ivao.aero"></textarea>
					</div>
				</div>
				<div class="form-group">
