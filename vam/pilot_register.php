...
<div class="row">
	<div class="col-md-12">
		<div class="card shadow mb-4">
			<div class="card-header py-3"><?php echo REGISTER_WRONG; ?></div>
					...
					<div>
						<?php
								...
								<div class="row">
									<div class="col-md-12">
										<div class="card shadow mb-4">
											...
											<div class="card-header py-3"><?php echo REGISTER_FORM; ?></div>
											<p>
                            ...
                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
												...
												<div class="form-group">
													<label class="control-label col-sm-2"
													       for="city"><?php echo PILOT_CITY_REG_FORM; ?></label>
													<div class="col-sm-4">
												...
												<div class="form-group">
													<label class="control-label col-sm-2"
													       for="notes">Callsign Deseado:</label>
													<div class="col-sm-4">
														<input type="notes" class="form-control" name="notes" id="notes"
														          placeholder="Elige tus 3 numeros de tu Callsign (Ej. 123)"></textarea>
													</div>
												</div>
												<div class="form-group">
