<?php
	...
	define ('READ_RULES' , 'Ich habe die VA Regeln gelesen und bin mit diesen Regeln einverstanden');
...
Sie werden eine neue Email erhalten wenn wir Ihre Registrierung bearbeitet haben. (Wir bitten Sie, president@terra-fly.de als sichere Emailadresse zu listen - wenn Sie keine neue Email erhalten, bitten wir Sie in Ihren Spam Folder nachzusehen)');
	define ('REGISTER_CAPTCHA_MSG' , 'Captcha falsch, bitte nochmal versuchen');
	...
	// Home Page (index.php)
	define ('WELCOME_VA' , 'WILLKOMMEN bei der ');
	...
	define ('FUTURE_EVENTS' , 'KOMMENDE EVENTS');
	...
	define ('PILOT_STATICS' , 'PERSÖNLICHE STATISTIK');
	...
	define ('STATUS_LOST_1' , 'Flugzeug Status Verlust bei Landerate 0 ft/min und -');
	define ('STATUS_LOST_2' , 'Flugzeug Status Verlust bei Landerate -');
	define ('AND_STRING' , ' und -');
	...
	// Book a route
	define ('AVAILABLE_ROUTES' , 'VERFÜGBARE ROUTEN');
	define ('ROUTES_BOOKED' , 'GEBUCHTES FLUGZEUG UND ROUTE');
	...
	define ('BOOK_ROUTE_CONFIRM' , 'Korrekt gebucht. Die Reservierung wir automatisch in 24 Stunden gelöcht.');
	...
	define ('STATISTICS_TOP5_ROUTES' , 'TOP 5 ROUTEN');
	...
	// User not recognized
	define ('INDEX_NO_USER' , 'Kein Zugang. User oder Passwort falsch');
	...
	define ('ADM_ROUTE_MGR' , 'Routen bearbeiten');
	define ('ADM_ROUTE_FLEET_MGR' , 'Route/Flugzeug bearbeiten');
	...
	define ('VAMACARS_NETWORK' , 'Netzwerk');
	define ('VAMACARS_DATEDETAIL' , 'Datum');
	define ('VAMACARS_FUELCONSUMED' , 'FUEL VERBRAUCH');
	...
	define ('VAMACARS_FUEL_USED' , 'FUEL VERBRAUCH');
	...
	// VAM 2.3 BEGIN
	define ('VAMACARS_VALIDATION_COMMENTS' , 'VALIDATION ANMERKUNGEN');
	define ('VAMACARS_VALIDATION_COMMENT' , 'ANMERKUNG');
	define ('VAMACARS_FLIGHT_RATING' , 'Flight Rating');
	define ('VAMACARS_CRASH' , 'Crashed');
	define ('VAMACARS_VALIDATOR_COMMENTS' , 'Validator Anmerkungen');
	define ('VAMACARS_VALIDATION_ADD_COMMENT' , 'Anmerkung hinzufügen');
	define ('VAMACARS_VALIDATION_ACCEPT' , 'Akzeptiert');
	define ('VAMACARS_VALIDATION_REJECT' , 'Zurückgewiesen');
	define ('VAMACARS_NO' , 'Nein');
	define ('VAMACARS_YES' , 'Ja');
	...
	// VAM 2.4 BEGIN
	define ('AIRPORT_AIRPORT_METAR' , 'METAR UND TAF INFORMATION');
	...
	define ('ROUTES_VA_SEARCHER', 'Route suchen');
	...
	define ('AIRCRAFT_DETAILS_CRUISE_SPEED' , 'Maximale Geschwindigkeit');
	...
	define ('HUB_ROUTES' , 'HUB ROUTEN');
	define ('HUB_MAP_LOCATION' , 'KARTE ROUTEN');
	...
	define ('HUB_NUM_ROUTES' , 'Anzahl der Routen');
	...
	define ('TOURS_VA' , 'TOUREN');
	define ('TOURS_ACTIVE' , 'AKTIVE TOUREN');
	define ('TOURS_INACTIVE' , 'INAKTIVE TOUREN');
	define ('TOUR_DETAILS' , 'TOUREN DETAILS');
	define ('TOUR_LEGS' , 'TOUREN LEGS');
	define ('TOURS_STATUS' , 'TOUREN STATUS');
	...
	define ('VA_GLOBAL_FINANCES' , 'TERRA-FLY GLOBAL FINANZBERICHT');
	define ('COSTS' , 'KOSTEN');
	define ('INCOME' , 'EINKOMMEN');
	define ('INCOME_REGULAR_ROUTES' , 'GEWINN- UND VERLUST LINIENVERKEHR');
              define ('Cargo in regular routes' , 'FRACHTEINNAHMEN LINIENVERKEHR');
	define ('AIRCRAFT_PURCHASE' , 'KAUF VON FLUGZEUGEN');
	define ('FINANCE_BALANCE' , 'AKTUELLER KONTOSTAND');
	define ('GLOBAL_FINANCES' , 'Global Finanzbericht');
	define ('COSTS_PILOTS_SALARY' , 'KOSTEN PILOTEN GEHALT');
	define ('COSTS_AIRCRAFT_REPAIR' , 'KOSTEN FLUGZEUG REPARATUREN');
	define ('COSTS_AIRCRAFT_MAINTENANCE' , 'KOSTEN FLUGZEUG WARTUNG');
	// LIVE MAP
	define ('FLIGHT_STAGE' , 'Flugphase');
	define ('PERC_DONE' , '% fertig gestellt');
