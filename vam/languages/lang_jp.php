<?php
	...
	define ('ADMIN' , '運営');
	// Pilot Roster
	define ('PILOT_ROSTER' , 'パイロット');
	define ('CALLSIGN' , 'コールサイン');
	define ('NAME' , '名前');
	define ('HUB' , 'ハブ');
	define ('LOCATION' , '場所');
	define ('HOURS' , '時間');
	...
	// Routes list
	define ('ROUTES_VA' , 'ルート');
	define ('FLIGHT_VA' , 'フライト');
	define ('DEPARTURE' , '出発');
	define ('ARRIVAL' , '到着');
	define ('DEPARTURE_TIME' , '出発時刻');
	define ('ARRIVAL_TIME' , '到着時刻');
	define ('ROUTE_PLANE' , 'Plane Type');
	// Pilot Register form
	define ('REGISTER_FORM' , '登録フォーム');
	define ('PILOT_NAME_REG_FORM' , 'Name:');
	define ('PILOT_LASTNAME_REG_FORM' , '名字:');
	define ('PILOT_BIRTHDATE_REG_FORM' , '誕生日:');
	define ('PILOT_IVAOID_REG_FORM' , 'IVAO ID:');
	define ('PILOT_VATSIMID_REG_FORM' , 'VATSIM ID:');
	define ('PILOT_COUNTRY_REG_FORM' , '国籍:');
	define ('PILOT_LANGUAGE_REG_FORM' , '言語:');
	define ('PILOT_CITY_REG_FORM' , '都道府県:');
	define ('PILOT_HUB_REG_FORM' , 'ハブ:');
	define ('PILOT_EMAIL_REG_FORM' , 'Email:');
	define ('PILOT_PASSWORD_REG_FORM' , 'パスワード:');
	define ('PILOT_CONFIRMPASSWORD_FORM' , '再度パスワード:');
	define ('PILOT_COMMENTS_REG_FORM' , 'コメント:');
	define ('BUTTONSUBMIT_REG_FORM' , '登録');
	define ('PILOT_NAME_PLACEHOLER_REG_FORM' , '名前記入');
	define ('PILOT_LASTNAME_PLACEHOLER_REG_FORM' , '名字記入');
	define ('PILOT_BIRTHDATE_PLACEHOLER_REG_FORM' , '誕生日記入');
	define ('PILOT_IVAOID_PLACEHOLER_REG_FORM' , 'Enter IVAO ID');
	define ('PILOT_VATSIMID_PLACEHOLER_REG_FORM' , 'Enter VATSIM ID');
	define ('PILOT_CITY_PLACEHOLER_REG_FORM' , '都道府県記入');
	define ('PILOT_EMAIL_PLACEHOLER_REG_FORM' , 'メール記入');
	define ('PILOT_PASSWORD_PLACEHOLER_REG_FORM' , 'パスワード');
	define ('PILOT_COMMENTS_PLACEHOLER_REG_FORM' , '再度パスワード');
	define ('READ_RULES' , 'virtual ANAの規約に同意します。');
	// Pilot Register Succesfull Page (index.php?page=pilot_insert)
	define ('REGISTER_SUCCESSFUL' , '登録完了');
	define ('REGISTER_SUCCESSFUL_MSG' , 'ただいま審議中です。１〜３日にメールをお送りいたします。');
	define ('REGISTER_CAPTCHA_MSG' , 'Captcha incorrect, please try again');
	define ('REGISTER_WRONG' , 'Wrong registration');
	define ('REGISTER_WRONG_MSG' , 'メールアドレス使用中');
	define ('REGISTER_CLOSED_MSG' , '新規加入者を停止しています。');
	// Password Recover
	...
	define ('PASSWORD_RESET_OK_MSG' , '新しいパスワードをお送りいたします。');
	// Home Page (index.php)
	define ('WELCOME_VA' , 'ようこそ ');
	define ('FLIGHT_NETWORKS' , 'FLIGHT NETWORKS');
	define ('TWEETS' , 'ツイート');
	// Home Page LAST FLIGTS grid
	define ('LATEST_FLIGHTS_VA' , '最新のフライト');
	define ('LF_CALLSIG' , 'コールサイン');
	define ('LF_PILOT' , '乗務員');
	define ('LF_DEPARTURE' , '出発');
	define ('LF_ARRIVAL' , '到着');
	define ('LF_FLIGHTDATE' , '日付');
	define ('LF_FLIGHTTIME' , 'フライト時間');
	// Home Page STATICS grid
	define ('STATISTICS_VA' , 'スタティスティックス');
	define ('ST_NUMPILOTS' , 'パイロット');
	define ('ST_NUMPLANES' , '使用機材');
	define ('ST_NUMROUTES' , 'ルート');
	define ('ST_NUMFLIGHTS' , '合計フライト');
	define ('ST_NUMCHARTER' , '合計チャーター');
	define ('ST_NUMREGULAR' , 'レギュラーフライト');
	define ('ST_PERREGULAR' , '% レギュラーフライト');
	// Home Page NEWEST PILOTS grid
	define ('NEWEST_PILOTS_VA' , '新人パイロット');
	define ('NEWPILOT' , 'パイロット');
	define ('NEWJOINED' , '加入');
	...
	define ('FUTURE_EVENTS' , 'イベント');
	define ('EVENT_NAME' , 'イベント');
	define ('EVENT_DATE' , '日付');
	// NOTAM table
	define ('NOTAM' , 'NOTAM');
	...
	// EVENT table
	define ('EVENT' , 'イベント');
	define ('EVENT_NAME_PANEL' , 'イベント名');
	define ('EVENT_CREATE_DATE' , 'イベント作成日');
	define ('EVENT_PUBLISH_DATE' , 'イベント承認日');
	define ('EVENT_TEXT' , 'イベント詳細');
	// Pilot page
	define ('PILOT_PROFILE' , 'プロフィール');
	define ('PILOT_STATICS' , 'パーソナルスタティスティックス');
	define ('PILOT_CERTIFICATIONS' , 'パイロット資格');
	define ('PILOT_NAME' , '名前:');
	define ('PILOT_CALLSIGN' , 'コールサイン:');
	define ('PILOT_COUNTRY' , '国籍:');
	define ('PILOT_CITY' , '都道府県:');
	define ('PILOT_HUB' , 'ハブ:');
	define ('PILOT_LOCATION' , '場所:');
	define ('PILOT_RANK' , 'ランク:');
	define ('PILOT_SALARY' , '給料:');
	define ('PILOT_MONEY' , '資産:');
	define ('PILOT_REGISTERDATE' , '入社日:');
	define ('PILOT_FLIGHTS' , 'フライト乗務合計:');
	define ('PILOT_HOURS' , '乗務時間:');
	define ('PILOT_FLIGHTSREGULAR' , 'レギュラーフライト:');
	define ('PILOT_FLIGHTSCHARTER' , 'チャーターフライト:');
	define ('PILOT_DISTANCE' , '距離:');
	define ('PILOT_PERFLIGHTREGULAR' , '% レギュラーフライト:');
	define ('PILOT_MANUALREPORT' , 'マニュアルレポート:');
	...
	define ('PILOT_FLIGTHS' , 'フライト');
	define ('PILOT_FLIGTHS_DEP' , '出発');
	define ('PILOT_FLIGTHS_ARR' , '到着');
	define ('PILOT_FLIGTHS_DATE' , '日付');
	define ('PILOT_FLIGTHS_DUR' , '時間');
	define ('PILOT_FLIGTHS_DIST' , '距離');
	define ('PILOT_FLIGTHS_TYPE' , 'タイプ');
	define ('PILOT_FLIGTHS_VALI' , '承認');
	define ('PILOT_FLIGTHS_DETAILS' , '詳細');
	// FSACARS LOG page
	define ('FSACARS_TRACK' , 'フライトトラック');
	define ('FSACARS_PARAMETER' , 'パラミター');
	define ('FSACARS_VALUE' , 'バリュー');
	define ('FSACARS_DEPARTURE' , '出発:');
	define ('FSACARS_ARRIVAL' , '到着:');
	define ('FSACARS_FLIGHTYPE' , 'フライトタイプ:');
	define ('FSACARS_FLIGHT_CHARTER' , 'チャーター');
	define ('FSACARS_FLIGHT_REGULAR' , 'レギュラー');
	define ('FSACARS_STATUS_VALIDATED' , '承認済み');
	define ('FSACARS_STATUS_NOVALIDATED' , '承認待ち');
	define ('FSACARS_STATUS_REJECTED' , '却下');
	define ('FSACARS_STATUS' , 'ステータス:');
	define ('FSACARS_DATE' , '日付:');
	define ('FSACARS_DURATION' , '時間:');
	define ('FSACARS_PLANETYPE' , '使用機材:');
	define ('FSACARS_FUEL' , '燃料:');
	define ('FSACARS_DISTANCE' , '距離:');
	define ('FSACARS_TOUCHDOWN' , '着陸レート:');
	define ('FSACARS_LOG' , 'ログ:');
	// FSKEEPER LOG page
	define ('FSKEEPER_TRACK' , 'フライトトラック');
	define ('FSKEEPER_PILOT' , 'パイロット:');
	define ('FSKEEPER_AIRCRAFT' , '使用機材:');
	define ('FSKEEPER_DISTANCE' , '距離:');
	define ('FSKEEPER_DEPARTURE' , '出発:');
	define ('FSKEEPER_ARRIVAL' , '到着:');
	define ('FSKEEPER_TIME' , '時間:');
	...
	define ('FSKEEPER_FLIGHT_CHARTER' , 'チャーター');
	define ('FSKEEPER_FLIGHT_REGULAR' , 'レギュラー');
	define ('FSKEEPER_STATUS_VALIDATED' , '承認済み');
	define ('FSKEEPER_STATUS_NOVALIDATED' , '承認待ち');
	define ('FSKEEPER_STATUS_REJECTED' , '却下');
	define ('FSKEEPER_PASSENGERS' , '搭乗人数:');
	...
	define ('OPTION_MAIL' , '内部メール');
	define ('OPTION_ROUTE_RESERVE' , 'ルートを予約');
	define ('OPTION_CHANGE_LOCATION' , 'ロケーションを変更');
	define ('OPTION_BANK' , '銀行');
	define ('OPTION_MANUAL_PIREP' , '手動パイレプ');
	define ('OPTION_PROFILE' , 'プロフィールを変更');
	define ('OPTION_STATS' , '私のスタティスティックス');
	define ('OPTION_VA_PARAMETER' , 'VA パラミター');
	define ('OPTION_DOWNLOADS' , 'ダウンロード');
	// VA Parameters
	...
	define ('DAYS' , ' days');
	// My Bank
	define ('FINANCIAL_TRANSACTIONS' , '金融取引');
	define ('BANK_DATE' , '日付');
	define ('BANK_AMOUNT' , '残高');
	define ('BANK_REASON' , 'ロケーション変更・フライト');
	define ('BANK_TOTAL_MONEY' , '合計: ');
	// Book a route
	...
	define ('BOOK_ROUTE_FLIGHT' , 'フライト');
	define ('BOOK_ROUTE_DEPARTURE' , '出発');
	define ('BOOK_ROUTE_ARRIVAL' , '到着');
	...
	define ('BOOK_ROUTE_ARICRAFT_TYPE' , '使用機材');
	define ('BOOK_ROUTE_ARICRAFT_REG' , '登録番号');
	define ('BOOK_ROUTE_ARICRAFT_STATUS' , '機材状況');
	...
	define ('MY_PROFILE' , '私のプロフィール');
	define ('MY_PROFILE_UPDATE_BTN' , 'アップデート');
	define ('MY_PROFILE_UPDATED' , 'プロフィールがアップデートされました！');
	...
	// Downloads
	define ('DOWNLOADS' , 'ダウンロード');
	define ('DOWNLOAD_NAME' , '名');
	define ('DOWNLOAD_LINK' , 'リンク');
	// VAM 2.3 BEGIN
	...
	// LIVE MAP
	define ('FLIGHT_STAGE' , 'フライトステージ');
	define ('PERC_DONE' , '% 完了');
	define ('PENDING_NM' , '保留 NM');
	// VAM 2.6
